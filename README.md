...
`public/models.json` is generated by a Python scraper (vendored from
[AlexsJones/llmfit](https://github.com/AlexsJones/llmfit) with a
pre-quantized-repo sizing fix). Stdlib only — no pip deps.
